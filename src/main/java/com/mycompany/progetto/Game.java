...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        room1 = new Room(1, new Room1(), "C:\\Users\\Utente\\Documents\\NetBeansProjects\\Progetto\\src\\main\\java\\images\\cave_.jpg", "Boh", new Room1().background);
        getRooms().add(room0);
        getRooms().add(room1);
        room2 = new Room(2, new Room2(), "C:\\Users\\Utente\\Downloads\\imgproject\\lotr.jpg", "Caverna", new Room2().jLabel1);
